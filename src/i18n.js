...
const MESSAGES = {
  en: {
    ...
    used_since_delivery: 'Used since delivery',
    empty_around: 'Empty around',
    order_before: 'Order before',
    last_bag: 'Last bag used',
    stock_value: 'Stock value',
    monthly_cost: 'Cost per month',
    no_consumption: 'No consumption',
    rate_pending: 'Waiting for usage',
    low_stock: 'Low stock',
  ...
  fr: {
    ...
    used_since_delivery: 'Conso depuis livraison',
    empty_around: 'Vide vers le',
    order_before: 'Commander avant le',
    last_bag: 'Dernier sac utilisé',
    stock_value: 'Valeur du stock',
    monthly_cost: 'Coût par mois',
    no_consumption: 'Aucune conso',
    rate_pending: 'En attente de conso',
    low_stock: 'Stock bas',
